...
<head>
    ...
    <title>标签墙</title>
    <link rel="shortcut icon" href="favicon.ico"> <link href="<?php echo e(CSS_PATH); ?>bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="<?php echo e(JS_PATH); ?>content.min.js?v=1.0.0"></script>
</body>
</html>
